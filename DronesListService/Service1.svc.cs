...
namespace DronesListService
{
    ...
    public class Service1 : IService1
    {
        ...
        public StringBuilder GetManufacturerList()
        {
            ...
            if (dr.HasRows)
            {
                ...
                while (dr.Read())
                {
                    ...
                    temp.Append("<li value='" + dr.GetString(1).ToLower() + "' "
                        + " onclick=\"selectResult(this.innerHTML);\" >" + dr.GetString(1) + "</li>");
        ...
        public StringBuilder GetModelSizeList()
        {
            // create connection object
            SQLiteConnection conn = new SQLiteConnection();
        ...
        public StringBuilder GetDrones()
        {
            // create connection object
            SQLiteConnection conn = new SQLiteConnection();
            ...
            if (dr.HasRows)
            {
                ...
                while (dr.Read())
                {
                    ...
                    temp.Append("<li value='" + dr.GetString(0).ToLower() + "' "
                        + " onclick=\"selectResult(this.innerHTML);\" >" + dr.GetString(0) + "</li>");
